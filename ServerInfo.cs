    ...
    internal class ServerInfo
    {
        ...
        public byte[] RenderA2SInfoRespond()
        {
            ...
            if (Program.Config.GoldSrc)
            {
                ...
                bw.Write(Encoding.UTF8.GetBytes($"{m_ServerAddress}\0"));
                //Name	string	Name of the server.
                bw.Write(Encoding.UTF8.GetBytes($"{m_ServerName}\0"));
                //Map	string	Map the server has currently loaded.
                bw.Write(Encoding.UTF8.GetBytes($"{m_ServerMap}\0"));
                //Folder	string	Name of the folder containing the game files.
                bw.Write(Encoding.UTF8.GetBytes($"{m_ServerGameFolder}\0"));
                //Game	string	Full name of the game.
                bw.Write(Encoding.UTF8.GetBytes($"{m_ServerDescription}\0"));
                ...
                if (m_ServerModed)
                {
                    ...
                    bw.Write(Encoding.UTF8.GetBytes($"{m_ServerModInfo.m_ModUrl}\0"));
                    //Download Link	string	URL to download the mod.
                    bw.Write(Encoding.UTF8.GetBytes($"{m_ServerModInfo.m_ModDownloadUrl}\0"));
            ...
            else
            {
                ...
                bw.Write(Encoding.UTF8.GetBytes($"{Program.Config.Version}\0"));
        ...
        public byte[] RenderA2SPlayerRespond()
        {
            ...
            foreach (PlayerInfo info in m_ServerPlayers)
            {
                ...
                bw.Write(Encoding.UTF8.GetBytes($"{info.m_Name}\0"));
        ...
        public byte[] RenderA2SRulesRespond()
        {
            ...
            foreach (RulesInfo info in m_RulesInfos)
            {
                ...
                bw.Write(Encoding.UTF8.GetBytes($"{info.m_Value}\0"));
            }
            return [.. ms.ToArray()];
        }
        #endregion
